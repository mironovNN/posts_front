...
//   ['http://localhost:9999', 'ws://localhost:9999/ws'] : ['https://boot-coursar.herokuapp.com', 'ws://boot-coursar.herokuapp.com/ws'];

const [backendUrl, websocketUrl] = ['http://localhost:9999', 'ws://localhost:9999/ws'];
